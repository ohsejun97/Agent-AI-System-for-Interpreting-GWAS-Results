"""
Jansen et al. Sleep duration GWAS — Step 3: 근거 수집
입력: results/gene_mapping_results.csv
출력: results/evidence_results.csv
...
def query_gwas_catalog(snp_id: str) -> list:
    """SNP → studies → diseaseTrait 경로로 연관 형질 조회 (상위 3개)"""
...
print(f"[Step 3] 근거 수집: {len(gene_df)}개 SNP")
print("=" * 60)
